# -*- coding: utf-8 -*-
"""
Created on Sat Jan  9 14:28:55 2021
...
file_name = os.path.join(dirname, 'MCD_Factors.xlsx')
file_name2 = os.path.join(dirname, 'MCD_output.xlsx')
...
#solve for required rate and write output
